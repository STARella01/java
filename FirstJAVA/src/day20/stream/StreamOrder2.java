...
public class StreamOrder2 {
	...
	public static void main(String[] args) {
		// Shape을 상속 받는 자식들은 Shape의 area()에 따라서 비교..
		...
		list.stream().sorted((a,b) -> b.compareTo(a) - a.compareTo(b))  // b에 대하여 a를 뺐다.
		// b.compareTo(a) = 10  a.compareTo(b) = -10           // 10-(-10) = 20
		...
		System.out.println("=====람다표현식을 이용하여 둘레 역순 정렬=====");
