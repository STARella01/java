...
public class ObjectBasic1 {
	...
	// 객체 지향 - 현실 세계의 모든 것을 객체로 간추하고, 이 객체를 속성(멤버 변수)과 행위(메서드)를 갖는
	//  소프트웨어적 개념으로 표현한 것.
	...
	public static void main(String[] args) {
		...
		// 일일이 나열하지 말고 함수 불러서 사용하기 - calculator.java 파일 불러옴
		...
		System.out.println(cal1.equals(cal2)); // cal1과 cal2는 서로 다른 객체다!!!
	}
	 ...
	 *  생성사 : 클래스를 통해 객체를 생성하기 위해서 사용하는 것.
	...
	//이런 식으로 써도 됨 - Calculator.java 소스에 따로 선언하지 않아도 됨.
//	class Calculator {	
//		int result = 0 ; // default modifiers - default 접근 제한자
//		int add(int n) {
//			result +=n;
//			return result;
//		}
