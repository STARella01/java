...
public class ThreadEx11_1 {
	...
	public static void main(String[] args) {
		...
		// 엄마 스레드 객체 생성
		Mother2 mother = new Mother2(group, acc);
		// 아들 스레드 객체 생성		
		Son2 son = new Son2(group, acc);
...
class Mother2 extends Thread{
	...
	// 객체
	public Mother2(ThreadGroup group, Account account) {
		super(group, "엄마");  // super는 스레드 의미
...
class Son2 extends Thread{
	...
	Account account;
	// 객체
	Son2(ThreadGroup group, Account account){
		super(group, "아들");
		this.account = account;
	}
